...
public class DruckerDaoTest{
    ...
    public void testBUpdate() {
        String uid = "445335642105180160";
        Drucker entity = new Drucker();
        entity.setUid(uid);
        entity.setUserid("userid11111");
    ...
    public void testCGetById() {
        String uid = "445335642105180160";
        Drucker entity = dao.getById(uid);
...
//        assertEquals(testString, entity.getUname());
    ...
    public void testGetDList() {
        ...
        List<Drucker> list = dao.getList(queryMap);
